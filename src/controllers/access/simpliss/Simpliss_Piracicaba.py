...
from controllers.notifications.simpliss.Simpliss_Notification import SimplissNotification
import time

class SimplissAccess():
    ...
    def __init__(self, 
        ...
        self.simpliss_notification = SimplissNotification(webdriver, input_banner, input_banner_close)
    ...
    def login(self):
        ...
        try:
            ...
            if status_open_url['status']:
                ...
                status_notification = self.simpliss_notification.banner()
                    ...
                    if status_type_login['status']:
                        ...
                        if status_type_password['status']:
                            ...
                            if status_entrar['status']:
                                ...
                                status_web_iss = self.my_web.browser(
                                    'get', None, self.web_url)
                                
                                if status_web_iss['status']:
                                    self.status = True
                                ...
                                self.status = False                                
                                mensagem = 'Falha ao teclar "ENTER".'
                                print(mensagem)
        ...
        try:
            ...
            if status_button_sair['status']:
                ...
                if status_sair['status']:
                    ...
                    time.sleep(5)
                    self.status = True
                    mensagem = f'Sucesso em fazer Logoff.'
                    print(mensagem)
            ...
            self.status = False
            mensagem = f'Erro em fazer Logoff.'
            print(aviso)
